    ...
    private static BulletHellStageDefinition[] BuildStages()
    {
        ...
        return new[]
        {
            ...
            Stage(3, "自機狙い4+3way", "組み合わせ\n自機狙い3way＋時間差4way\n2秒ごとに発射\n間隔10°／6°\n弾速：40\n脅威度：1",
                ...
                Pattern(Projectile(40f, 1, 2f, 4, 6f, BulletAimType.FixedDown), 3f)),
            Stage(4, "編隊射撃", "強化\n自機狙い4way\n2秒ごとに発射\n間隔4°\n弾速：40\n脅威度：1",
            ...
            Stage(24, "単発の比例航法誘導弾", "単独認識\n比例航法誘導弾1発\n2秒ごとに発射\n角速度制限18deg/s\n比例定数2.6\n弾速：64\n脅威度：4",
                Pattern(Projectile(Motion(64f, 4, BulletMotionType.ProportionalNavigation, 18f, 2.6f), 2f))),
            Stage(25, "誘導弾　上級", "強化\n比例航法誘導弾を0.2秒間隔3発射\n2秒ごとに発射\n角速度制限18deg/s\n比例定数2.6\n弾速：64\n脅威度：5",
                Pattern(Projectile(Motion(64f, 5, BulletMotionType.ProportionalNavigation, 18f, 2.6f), 2f,
                    burstCount: 3, burstInterval: 0.2f))),
            Stage(26, "壁", "組み合わせ\n自機狙い10way＋時間差4way\n2秒ごとに発射\n間隔4°／45°\n弾速：40\n脅威度：1",
